...
以太坊抗审查历史几乎就是一部中国太监史，起初太监并无实权，整活的也只是极少数。因为历朝都要求太监不识字，没有文化还怎么干政。直到有一个叫朱瞻基的懒虫，为了自己摸鱼，系统性地传授太监知识。这回好了，起初太监也是好好干活的，直到他们尝到了权力的味道，一切都变了。为了制约太监的权利，将他们分割为批红和掌印两个部门，让他们自己内斗。

以太坊抗审查历史几乎一模一样，起初验证者也是一心一意的干活，直到 MEV 问题出现，这才发现幸福就在身边。为了制约验证者权利，社区自发地形成了事实上的 PBS (flashbot)，提议者就是批红太监，他们决定了内容，验证者就是掌印太监，决定了最终确定。

如同东厂西厂，纷争开始了。看起来权利分配得很合理，相互制约，实际上由于交易的不透明性，验证者只能全盘接受提议者的区块，而提议者并无动力提升抗审查性，导致浪费大量的 Gas，事实上验证者已经失去了制约提议者的能力。
